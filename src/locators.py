...
class MainPageLocators:
    ...
    ID_ORDER_HEADER = By.XPATH, "//p[contains(text(), 'идентификатор заказа')]"
...
class OrdersQueueLocators:
    ...
    ORDERS_QUEUE_NUMBERS = By.CSS_SELECTOR, "[class^='OrderFeed_order_number__']"
    CROSS_ICON_CLOSE_ORDER = By.XPATH, "//button[contains(@class, 'Modal_modal__close_modified__3V5XS Modal_modal__close__TnseK')]"
    PERSONAL_ACCOUNT_BUTTON = By.XPATH, "//a[contains(@class, 'AppHeader_header__link__3D_hX')]"
    ...
    IN_PROGRESS_ORDERS = By.CSS_SELECTOR, '[class^="Modal_modal__"] h2'